    ...
    <div className="sticky top-0 z-50 bg-[#f8f4ea] border-border-default">
      <div className="max-w-[1200px] mx-auto px-[clamp(18px,4vw,40px)] py-[14px] flex items-center justify-between gap-4 flex-wrap">
        ...
        >
          ...
          <span className="font-cormorant text-[23px] tracking-widest text-pb-green whitespace-nowrap">
            Petit Bond
          </span>
        </div>

        <div className="flex items-center gap-[clamp(16px,2.6vw,32px)] text-[14px] text-[#3f3b31] flex-wrap">
          <span
            onClick={() => router.push('/')}
          ...
          <span
            ...
            className="cursor-pointer whitespace-nowrap pb-1 transition-colors hover:text-pb-green"
          >
            經典系列
          </span>
          <span
        ...
        <button
          ...
          className="bg-pb-green text-[#f6efdd] text-[14px] tracking-widest px-[22px] py-[10px] rounded-full cursor-pointer whitespace-nowrap hover:shadow-lg hover:opacity-90 transition-all"
        >
          預購訂單
        </button>
      </div>
